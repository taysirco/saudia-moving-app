...
import { ClientMotion, ClientAnimatePresence } from '@/components/common/ClientMotion'
...
// Use dynamic import for motion components if needed
const MotionDiv = dynamic(() => import('framer-motion').then(mod => mod.motion.div), {
  ssr: false
})

export default function ReviewsSection({ city, serviceType }: ReviewsSectionProps) {
