...
const easternRegionServices = {
  'dhahran': {
    base: 'نقل عفش في الظهران - خدمات نقل متكاملة بأحدث المعدات | سعودي موفينج',
    services: {
      'moving-furniture': 'نقل عفش في الظهران - خدمة نقل منزلي شاملة مع الضمان',
      'furniture-moving': 'نقل اثاث في الظهران - خدمة نقل متكاملة مع الفك والتركيب',
      'furniture-transport': 'شركة نقل عفش في الظهران - خدمة نقل احترافية بأحدث المعدات',
      'moving-company': 'شركة نقل اثاث في الظهران - خدمة متميزة مع الضمان',
      'furniture-moving-company': 'افضل شركة نقل عفش في الظهران - خبرة 15 عام في النقل',
      'best-moving-company': 'شركة نقل عفش موثوقة في الظهران - جودة عالية وأسعار منافسة',
      'cheap-moving-company': 'شركة نقل عفش رخيصة في الظهران - اسعار تنافسية مع جودة الخدمة',
      'professional-moving-company': 'شركة نقل اثاث محترفة في الظهران - خدمة متميزة وعمالة مدربة',
      'licensed-moving-company': 'شركة نقل عفش مرخصة في الظهران - ضمان وموثوقية في النقل'
    }
  },
  'al-ahsa': {
    base: 'نقل عفش في الأحساء - خدمات نقل متكاملة مع الضمان | سعودي موفينج',
    services: {
      'moving-furniture': 'نقل عفش في الأحساء - خدمة نقل منزلي شاملة مع التغليف',
      'furniture-moving': 'نقل اثاث في الأحساء - خدمة نقل متكاملة مع الفك والتركيب',
      'furniture-transport': 'شركة نقل عفش في الأحساء - خدمة نقل احترافية بأحدث المعدات',
      'moving-company': 'شركة نقل اثاث في الأحساء - خدمة متميزة مع الضمان',
      'furniture-moving-company': 'افضل شركة نقل عفش في الأحساء - خبرة 15 عام في النقل',
      'best-moving-company': 'شركة نقل عفش موثوقة في الأحساء - جودة عالية وأسعار منافسة',
      'cheap-moving-company': 'شركة نقل عفش رخيصة في الأحساء - اسعار تنافسية مع جودة الخدمة',
      'professional-moving-company': 'شركة نقل اثاث محترفة في الأحساء - خدمة متميزة وعمالة مدربة',
      'licensed-moving-company': 'شركة نقل عفش مرخصة في الأحساء - ضمان وموثوقية في النقل'
    }
  },
  'hafar-al-batin': {
    base: 'نقل عفش في حفر الباطن - خدمات نقل متكاملة مع التأمين | سعودي موفينج',
    services: {
      'moving-furniture': 'نقل عفش في حفر الباطن - خدمة نقل منزلي شاملة مع التغليف',
      'furniture-moving': 'نقل اثاث في حفر الباطن - خدمة نقل متكاملة مع الفك والتركيب',
      'furniture-transport': 'شركة نقل عفش في حفر الباطن - خدمة نقل احترافية بأحدث المعدات',
      'moving-company': 'شركة نقل اثاث في حفر الباطن - خدمة متميزة مع الضمان',
      'furniture-moving-company': 'افضل شركة نقل عفش في حفر الباطن - خبرة 15 عام في النقل',
      'best-moving-company': 'شركة نقل عفش موثوقة في حفر الباطن - جودة عالية وأسعار منافسة',
      'cheap-moving-company': 'شركة نقل عفش رخيصة في حفر الباطن - اسعار تنافسية مع جودة الخدمة',
      'professional-moving-company': 'شركة نقل اثاث محترفة في حفر الباطن - خدمة متميزة وعمالة مدربة',
      'licensed-moving-company': 'شركة نقل عفش مرخصة في حفر الباطن - ضمان وموثوقية في النقل'
    }
  },
  'khafji': {
    base: 'نقل عفش في الخفجي - خدمات نقل متكاملة مع التغليف | سعودي موفينج',
    services: {
      'moving-furniture': 'نقل عفش في الخفجي - خدمة نقل منزلي شاملة مع التغليف',
      'furniture-moving': 'نقل اثاث في الخفجي - خدمة نقل متكاملة مع الفك والتركيب',
      'furniture-transport': 'شركة نقل عفش في الخفجي - خدمة نقل احترافية بأحدث المعدات',
      'moving-company': 'شركة نقل اثاث في الخفجي - خدمة متميزة مع الضمان',
      'furniture-moving-company': 'افضل شركة نقل عفش في الخفجي - خبرة 15 عام في النقل',
      'best-moving-company': 'شركة نقل عفش موثوقة في الخفجي - جودة عالية وأسعار منافسة',
      'cheap-moving-company': 'شركة نقل عفش رخيصة في الخفجي - اسعار تنافسية مع جودة الخدمة',
      'professional-moving-company': 'شركة نقل اثاث محترفة في الخفجي - خدمة متميزة وعمالة مدربة',
      'licensed-moving-company': 'شركة نقل عفش مرخصة في الخفجي - ضمان وموثوقية في النقل'
    }
  }
}
...
const pageTitles = {
  ...
  ...foodServiceMoving,
  ...easternRegionServices  // إضافة خدمات المنطقة الشرقية
}
